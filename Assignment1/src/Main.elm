...
update msg model =
    case msg of
        ...
        SelectEventCategory category ->
            ( {model | selectedEventCategories = (model.selectedEventCategories |> EventCategory.set category True)}
            , Cmd.none )

        DeselectEventCategory category ->
            ( {model | selectedEventCategories = (model.selectedEventCategories |> EventCategory.set category False)}
            , Cmd.none )
